...
" NOTE: I modified the black, gutter_bg and white colors to match the theme of the terminal
let s:black       = { "gui": "#232729", "cterm": "236" }
...
let s:white       = { "gui": "#cccccc", "cterm": "188" }
